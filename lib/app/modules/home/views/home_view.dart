                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          itemCount:
                              homeController.terbaruBookList.length,
                          itemBuilder: (context, index) {
                            DataBook dataBook =
                                homeController.terbaruBookList[index];
                            return BookCover(
                              bookTitle: '${dataBook.judul}',
                              bookImage: '${dataBook.image}',
                              onPressed: () {
...
class _CarouselState extends State<Carousel> {
  ...
  Widget build(BuildContext context) {
    final List<Image> imgList = [
      ...
      Image.asset('assets/perpustakaan_2.jpg', fit: BoxFit.cover),
      Image.asset('assets/perpustakaan_3.png', fit: BoxFit.cover),
      Image.asset('assets/perpustkaan_4.jpg', fit: BoxFit.cover),
    ];
    return Stack(
      children: [
        FlutterCarousel(
